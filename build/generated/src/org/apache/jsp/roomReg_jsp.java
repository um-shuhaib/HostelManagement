...
public final class roomReg_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<h2>Room Registration</h2>\n");
      out.write("\t\t<form method=\"post\">\n");
      out.write("\t\t\t<label for=\"room\">Room No. : </label>\n");
      out.write("\t\t\t<input type=\"text\" name=\"roomNo\" id=\"room\"><br>\n");
      out.write("\n");
      out.write("\t\t\t<label for=\"beds\">Total Beds : </label>\n");
      out.write("\t\t\t<input type=\"text\" name=\"beds\" id=\"beds\"><br>\n");
      out.write("\n");
      ...
      out.write("\t\t\t</select><br>\n");
      out.write("\n");
      out.write("\t\t\t<input type=\"submit\" value=\"Submit\" name=\"Submit\" style=\"margin-left: 75px;margin-top: 10%\">\n");
      out.write("\n");
      out.write("\t\t</form>\n");
      out.write("\t\t\n");
      out.write("\t</div>\n");
